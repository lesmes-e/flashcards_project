...
SECRET_KEY = 'django-insecure-5ytfc!*zg5ndf1w10x!jv!w&t%7)nm*330d@26+b&@^*^65xy6'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'flashcards_db',  # Nombre de la base de datos
        'USER': 'admin',     # Usuario de MySQL
        'PASSWORD': 'password',  # Contraseña de MySQL
        'HOST': '127.0.0.1',      # Dirección del contenedor MySQL
